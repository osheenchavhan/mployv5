...
const EmployerStack = () => {
  ...
  // Use onboardingComplete as the single source of truth
  const isProfileComplete = user?.onboardingComplete === true;
  
  console.log('EmployerStack - Profile status:', {
    ...
    <EmployerOnboardingProvider>
      <JobPostingProvider>
        <Stack.Navigator 
          ...
          initialRouteName={isProfileComplete ? "Dashboard" : "EmployerType"}
        >
          {/* Onboarding Screens */}
          <Stack.Screen name="EmployerType" component={EmployerType} />
